...
from .models import NGORegistration, BloodBankRegistration, BloodCampRSVP, BloodAlertSubscription

admin.site.register(NGORegistration)
admin.site.register(BloodBankRegistration)
admin.site.register(BloodCampRSVP)
admin.site.register(BloodAlertSubscription)
